...
public class CustomBlock extends Block
{
	...
	{ 
		this(material, name, hardness, resistance, harvesttool, harvestlevel, dropamountmax, minVienSize, maxVienSize, genChance, minGenY, maxGenY, generateIn, null, 1, generateInOverworld, generateInNether, generateInEnder);
	}
	
	public CustomBlock(Material material, String name, float hardness, float resistance, HarvestToolEnum harvesttool, HarvestLevelEnum harvestlevel, int dropamountmax, int minVienSize, int maxVienSize, int genChance, int minGenY, int maxGenY, boolean generateInOverworld, boolean generateInNether, boolean generateInEnder) 
	{ 
		this(material, name, hardness, resistance, harvesttool, harvestlevel, dropamountmax, minVienSize, maxVienSize, genChance, minGenY, maxGenY, new Block[]{Blocks.stone}, generateInOverworld, generateInNether, generateInEnder);
	}
	
	public CustomBlock(Material material, String name, float hardness, float resistance, HarvestToolEnum harvesttool, HarvestLevelEnum harvestlevel, int dropamountmax) 
	{ 
		super(material);
	...
	public CustomBlock(Material material, String name, float hardness, float resistance, int dropamountmax, int minVienSize, int maxVienSize, int genChance, int minGenY, int maxGenY, Block[] generateIn, Block[] generateNear, int generateDistance, boolean generateInOverworld, boolean generateInNether, boolean generateInEnder) 
	{
		super(material);
	...
	public CustomBlock(Material material, String name, float hardness, float resistance, int dropamountmax, int minVienSize, int maxVienSize, int genChance, int minGenY, int maxGenY, Block[] generateIn, int generateDistance, boolean generateInOverworld, boolean generateInNether, boolean generateInEnder) 
	{
		this(material, name, hardness, resistance, dropamountmax, minVienSize, maxVienSize, genChance, minGenY, maxGenY, generateIn, null, 1, generateInOverworld, generateInNether, generateInEnder);
	}
	
	public CustomBlock(Material material, String name, float hardness, float resistance, int dropamountmax, int minVienSize, int maxVienSize, int genChance, int minGenY, int maxGenY, boolean generateInOverworld, boolean generateInNether, boolean generateInEnder) {
		this(material, name, hardness, resistance, dropamountmax, minVienSize, maxVienSize, genChance, minGenY, maxGenY, null, 1, generateInOverworld, generateInNether, generateInEnder);
	}
